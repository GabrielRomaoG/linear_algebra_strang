...
\newtcbtheorem[number within=section]{Definition}{Definition}{enhanced,
    ...
    left={xshift=1cm,yshift*=1mm-\tcboxedtitleheight}, varwidth boxed
    title*=-3cm,
...
\newtcolorbox{note}[1][]{%
    ...
    attach boxed title to top
    left={xshift=1cm,yshift=-\tcboxedtitleheight/2,yshifttext=-\tcboxedtitleheight/2},
    ...
    boxed title style={%
        ...
        underlay={%
            ...
            \begin{scope}
                \clip (interior.north west) rectangle
                ([xshift=3ex]interior.east);
                \filldraw [white, blur shadow={shadow opacity=60,
                shadow yshift=-.75ex}, rounded corners=2pt]
...
\end{claim}}
\newcommand{\wc}[2]{
    \begin{wconc}{#1}{}\setlength{\parindent}{1cm}#2
\end{wconc}}
\newcommand{\thmcon}[1]{
    \begin{Theoremcon}{#1}
\end{Theoremcon}}
...
\end{Example}}
\newcommand{\dfn}[2]{
    \begin{Definition}[colbacktitle=red!75!black]{#1}{}#2
\end{Definition}}
\newcommand{\dfnc}[2]{
    \begin{definition}[colbacktitle=red!75!black]{#1}{}#2
\end{definition}}
...
\newcommand{\nt}[1]{
    \begin{note}#1
\end{note}}
\newcommand{\vlen}[1]{\lVert #1 \rVert}
...
{\addvspace{30pt}%
    \begin{tikzpicture}[remember picture, overlay]%
        ...
        \pgftext[left,x=-3.7cm,y=0.2cm]{\color{white}\Large\sc\bfseries
